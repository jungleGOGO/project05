...
-- 비밀번호 : 1q2w3e4r!@
insert into user (login_id, user_name, password, email, tel, addr1, addr2, postcode, birth) VALUES (1, 'admin', '관리자', '$2a$10$LEclL83IcxKcJT7/RX34j./XrDz4BudorZpdUqL0giJCChr1Fa5Xy', 'admin@tsherpa.com', '010-8524-2580', '기본주소', '상세주소', '00101', 1990-11-09);
